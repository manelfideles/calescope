		...
		defaultValues: {
			...
			userSettings: {
				metricSystem: localStorage.getItem('settings')
					? JSON.parse(localStorage.getItem('settings')!).userSettings.metricSystem
					: 'metric'
			}
		}
	});
							...
							<Stack fontSize='sm' fontWeight='bold'>
								...
								<Box>
									...
									<FormInput
										...
										label=''
										fieldError={form.formState.errors.userSettings?.metricSystem}
									>
										<Select
											size='sm' width='50%'
											isDisabled={!isEditing}
							...
							<Stack width='80%' fontSize='sm' fontWeight='bold'>
								...
								<Box marginY={4}>
									<Text fontWeight='normal'>
										Here are listed all the variables that are available for display on the dashboard.
										Click on them to toggle their visibility on the dashboard.
									</Text>
									<Link
										fontSize='sm'
										fontWeight='normal'
